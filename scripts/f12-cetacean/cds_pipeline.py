...
SPECIES = [
    ...
    ("Vicugna_pacos","alpaca"),("Camelus_dromedarius","camel"),
    ("Equus_caballus","horse"),("Canis_lupus_familiaris","dog"),
    ("Loxodonta_africana","elephant"),("Mus_musculus","mouse"),
    # pig (Sus_scrofa) dropped: ~57% gaps through the exon-3 frameshift window in
    # this cactus alignment, which read as a near-empty row in the figures.
]
