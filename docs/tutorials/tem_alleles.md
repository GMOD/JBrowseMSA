...
Eleven kilobytes percent-encode to more than the 8,192-character request line a
`?data=` link fits in, so the snapshot names the file and the viewer fetches it
at startup:
