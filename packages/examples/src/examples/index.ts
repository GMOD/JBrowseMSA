...
export const examples: Example[] = [
  ...
  },
  {
    ...
    category: 'Protein domains',
    description:
      'The same Src-family kinases, with a contact map from the solved ' +
      'structure over the domain boxes. The boxes say the family is SH3 + ' +
      'SH2 + kinase; the arcs say how the three pack, which is the mechanism ' +
      '— the C-terminal tail folds back so phospho-Tyr527 binds the protein’s ' +
      'own SH2 domain and clamps the kinase shut. C-beta pairs under 8 Å in ' +
      'PDB 2SRC, mapped to UniProt numbering through SIFTS and filtered to ' +
      'the pairs that join two different domains.',
    Component: KinaseContacts,
    source: KinaseContactsSrc,
  },
  {
